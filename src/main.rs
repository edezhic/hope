...
fn main() -> Result<()> {
    ...
    Comments inside ``
    */
    bot._do(r#"Column as [1.333, 2, 3,5], table as {column, column2: [0, 0]}, struct as {table, flag}."#)?;
    bot._do(r#"Show flag of struct. Set flag of struct to no. Show flag of struct."#)?;
    bot._do(r#"Sum column of table of struct. Show result."#)?;
